...
*c. crie uma classe CamaroteInferior (que possui a localização do ingresso e métodos para acessar e imprimir esta localização) e 
...
c. codifique um main ao qual você deve criar um imóvel. Peça para o usuário digitar 1 para novo e 2 para velho. Conforme a definição do usuário, imprima o valor final do imóvel. Implemente o seguinte diagrama de classe

 */
public class CamaroteSuperior extends Vip{
	protected int localizacaoIngresso;
	protected double adicionalSuperior=10;
	...
	public double valorIngressoVip() {
		return (this.valorIngresso+this.adicional+this.adicionalSuperior);
	}
